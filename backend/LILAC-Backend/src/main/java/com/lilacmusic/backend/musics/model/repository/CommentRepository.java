...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query("SELECT c.code AS code, c.content AS content, c.presentTime AS presentTime, c.createdTime AS createdTime, u.nickname AS nickname, u.profileImage AS profileImage FROM Comment c INNER JOIN Member u ON c.memberId = u.memberId WHERE c.musicId = ?1")
